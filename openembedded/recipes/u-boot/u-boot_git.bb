...
SRC_URI_alico = "git://www.denx.de/git/u-boot.git;branch=master;protocol=git \
                file://0001-alico-adding-u-boot.patch \
"
SRCREV_alico = "41d5718ee6fb36a1282cde6c86b55f83b62278e1"
PV_alico = "2010.06+${PR}+gitr${SRCREV}"
PE_alico = "1"
do_compile_alico () {
